...
//	    	Hashtable<Integer, String> searchResults = new Hashtable<Integer, String>();
        	...
        	if(!index.containsKey(words[0].toLowerCase())) return res;
...
//	        }
	...
	public static void main(String args[]) throws IOException{
		try {
//        FileIndex fileIndex = new FileIndex(new String[]{"H:\\UoW\\ACC\\Workspace\\ACC_Project_WebSearch\\src\\httpask.uwindsor.ca.txt","H:\\UoW\\ACC\\Workspace\\ACC_Project_WebSearch\\src\\httpsblackboard.uwindsor.ca.txt"});
         buildIndex(new String[]{"H:\\UoW\\ACC\\Workspace\\ACC_Project_WebSearch\\src\\httpask.uwindsor.ca.txt","H:\\UoW\\ACC\\Workspace\\ACC_Project_WebSearch\\src\\httpsblackboard.uwindsor.ca.txt"});
