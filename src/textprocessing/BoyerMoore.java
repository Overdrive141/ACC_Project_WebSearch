...
public class BoyerMoore {
    ...
    public int searchOld(String txt) {
        int M = pat.length();
        int N = txt.length();
        int skip;
    ...
    public static void main(String[] args) {
        ...
        String txt = "abracadabrafabra  abracadabra cad abracadabra abrdslfdslfdabracadabrslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdslfdskjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgkjgad";
        ...
        System.out.println("Found" + offset1);
        int count = 0;
        if(offset1+pat.length()>=txt.length()) {
