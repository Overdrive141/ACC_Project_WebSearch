...
public BinaryNode<AnyType> newNode = null;  // Used between different inserts
 ...
 public BinaryNode<AnyType> header = new BinaryNode<AnyType>( null ); // For splay
  ...
  */
 public BinaryNode<AnyType> splay( AnyType x, BinaryNode<AnyType> t )
 {
  ...
  */
public static <AnyType> BinaryNode<AnyType> rotateWithLeftChild( BinaryNode<AnyType> k2 )
 {
  ...
  */
public static <AnyType> BinaryNode<AnyType> rotateWithRightChild( BinaryNode<AnyType> k1 )
 {
...
public BinaryNode<AnyType> nullNode;
 ...
 public static void main( String [ ] args )
 {
     ...
     t.printTree( );
//     System.out.println("meme"+t.root.accesselement());
     for( int i = 1; i < NUMS; i++)
     {
    	 if (!t.contains( i ))
